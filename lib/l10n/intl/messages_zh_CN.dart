...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "backgroundOptimization": MessageLookupByLibrary.simpleMessage("后台优化"),
    "backgroundOptimizationDesc": MessageLookupByLibrary.simpleMessage(
      "应用进入后台时自动优化资源占用",
    ),
    "backgroundOptimizationLevel": MessageLookupByLibrary.simpleMessage("优化级别"),
    ...
    "autoRouteDesc": MessageLookupByLibrary.simpleMessage("开启后将覆盖配置中的auto-route选项"),
    "strictRoute": MessageLookupByLibrary.simpleMessage("严格路由"),
    "strictRouteDesc": MessageLookupByLibrary.simpleMessage("开启后将覆盖配置中的strict-route选项，启用自动路由后可用"),
    "autoDetectInterface": MessageLookupByLibrary.simpleMessage("自动检测接口"),
    "autoDetectInterfaceDesc": MessageLookupByLibrary.simpleMessage("开启后将覆盖配置中的auto-detect-interface选项"),
    "sniffer": MessageLookupByLibrary.simpleMessage("域名嗅探"),
    "snifferDesc": MessageLookupByLibrary.simpleMessage("更新域名嗅探相关设置"),
    "overrideSniffer": MessageLookupByLibrary.simpleMessage("覆写嗅探"),
    "overrideSnifferDesc": MessageLookupByLibrary.simpleMessage("开启后将覆盖配置中的嗅探选项"),
    "snifferEnableDesc": MessageLookupByLibrary.simpleMessage("启用域名嗅探以进行协议检测"),
    "forceDnsMapping": MessageLookupByLibrary.simpleMessage("强制DNS映射"),
    "forceDnsMappingDesc": MessageLookupByLibrary.simpleMessage("对redir-host类型识别的流量进行强制嗅探"),
    "parsePureIp": MessageLookupByLibrary.simpleMessage("解析纯IP"),
    "parsePureIpDesc": MessageLookupByLibrary.simpleMessage("对所有未获取到域名的流量进行强制嗅探"),
    "overrideDestination": MessageLookupByLibrary.simpleMessage("覆写目标地址"),
    "overrideDestinationDesc": MessageLookupByLibrary.simpleMessage("使用嗅探结果作为实际访问地址"),
    "sniffProtocol": MessageLookupByLibrary.simpleMessage("嗅探协议"),
    "forceDomain": MessageLookupByLibrary.simpleMessage("强制嗅探域名"),
    "forceDomainDesc": MessageLookupByLibrary.simpleMessage("对这些域名强制进行嗅探"),
    "skipDomain": MessageLookupByLibrary.simpleMessage("跳过嗅探域名"),
    "skipDomainDesc": MessageLookupByLibrary.simpleMessage("对这些域名跳过嗅探"),
    "skipSrcAddress": MessageLookupByLibrary.simpleMessage("跳过来源地址"),
    "skipSrcAddressDesc": MessageLookupByLibrary.simpleMessage("对这些来源IP段跳过嗅探"),
    "skipDstAddress": MessageLookupByLibrary.simpleMessage("跳过目标地址"),
    "skipDstAddressDesc": MessageLookupByLibrary.simpleMessage("对这些目标IP段跳过嗅探"),
