...
class AppLocalizations {
  ...
  /// `Group by process`
  String get connectionGroupByProcess {
    return Intl.message(
      'Group by process',
      name: 'connectionGroupByProcess',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Group by host`
  String get connectionGroupByHost {
    return Intl.message(
      'Group by host',
      name: 'connectionGroupByHost',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Group by chain`
  String get connectionGroupByChain {
    return Intl.message(
      'Group by chain',
      name: 'connectionGroupByChain',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Ungrouped`
  String get connectionUngrouped {
    return Intl.message(
      'Ungrouped',
      name: 'connectionUngrouped',
      desc: '',
      args: [],
    );
  }
  ...
  String subscriptionExpiringDesc(Object days) {
    return Intl.message(
      'Your subscription will expire in $days days',
      name: 'subscriptionExpiringDesc',
      desc: '',
      args: [days],
    );
  }
  ...
  String get profileFilter {
    return Intl.message('Filter', name: 'profileFilter', desc: '', args: []);
  }

  /// `Deduplicate nodes`
  String get profileDeduplicate {
    return Intl.message(
      'Deduplicate nodes',
      name: 'profileDeduplicate',
      desc: '',
      args: [],
    );
  }
  ...
  String get profileDeduplicateDesc {
    return Intl.message(
      'Remove duplicate nodes from the profile',
      name: 'profileDeduplicateDesc',
      desc: '',
      args: [],
    );
  }

  /// `Removed {count} duplicate nodes`
  String profileDeduplicateResult(Object count) {
    return Intl.message(
      'Removed $count duplicate nodes',
      name: 'profileDeduplicateResult',
      desc: '',
      args: [count],
    );
  }
